...
<html lang="it">
  ...
  <body style = "background-color:white">
    <center><br><br><h1>Acquista</h1><br>   
...
<form action="#" method="POST">
  <div class="form-row">
    ...
    <select id="id_prodotto" name="id_prodotto" class="form-control">
      ...
      ?>
<br>
<button type="submit" id="submit_btn" name="submit_btn" class="btn btn-primary">Acquista</button><br><br>
    </form>
        ...
        if (isset($_POST["submit_btn"])) {
            ...
            if($id_prodotto<0){
                ...
                if($rows > 0){ 
                    ...
                    $output = $db_connection->query("INSERT INTO `utenti_prodotti`(`id_prodotto`, `id_user`) VALUES ('$id_prodotto','$id_user')");
